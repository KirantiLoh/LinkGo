...
CREATE TABLE `Page` (
    ...
    `bgColor` VARCHAR(191) NOT NULL DEFAULT '#121212',
...
-- AddForeignKey
ALTER TABLE `Link` ADD CONSTRAINT `Link_pageId_fkey` FOREIGN KEY (`pageId`) REFERENCES `Page`(`userId`) ON DELETE RESTRICT ON UPDATE CASCADE;
